...
export const metadata: Metadata = {
  title: 'About Us | SWAROBO',
  description: 'Learn about SWAROBO, our mission, and the team driving innovation in swarm robotics.',
};
    ...
    <div className="space-y-12 md:space-y-16">
      <section className="text-center">
        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
          About <span className="text-primary">SWAROBO</span>
        </h1>
      ...
      <section>
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
            The passionate minds behind SWAROBO, driving the future of autonomous collaboration.
          </p>
        </div>
